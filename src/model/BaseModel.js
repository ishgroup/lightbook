...
class BaseModel {
  ...
  static post(that, url, data, callback) {
    axios.post(url, data, { baseURL: Config.baseUrl(), headers: { 'Content-Type' : 'application/json' } })
      .then(function(response) {
        if(response.data.status === 'success')
          callback(that, response);
        else {
  ...
  static put(that, url, data, callback) {
    axios.put(url, data, { baseURL: Config.baseUrl(), headers: { 'Content-Type' : 'application/json' } })
      .then(function(response) {
        if(response.data.status === 'success')
          callback(that, response);
        else {
  ...
  static patch(that, url, data, callback) {
    axios.patch(url, data, { baseURL: Config.baseUrl(), headers: { 'Content-Type' : 'application/json' } })
      .then(function(response) {
        if(response.data.status === 'success')
          callback(that, response);
        else {
  ...
  static delete(that, url, callback) {
    axios.delete(url, { baseURL: Config.baseUrl(), headers: { 'Content-Type' : 'application/json' } })
      .then(function(response) {
        if(response.data.status === 'success')
          callback(that, response);
        else {
